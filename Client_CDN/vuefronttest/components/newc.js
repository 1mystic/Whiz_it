...
const newc = {
    ...
    data() {
        return {
            ...
            stats: [
                { title: 'Subjects', value: '', icon: 'fas fa-book', color: 'blue' },
                { title: 'Chapters', value: '', icon: 'fas fa-bookmark', color: 'green' },
                { title: 'Quizzes', value: '', icon: 'fas fa-question-circle', color: 'orange' },
                { title: 'Questions', value: '', icon: 'fas fa-tasks', color: 'purple' },
                { title: 'Users', value: '', icon: 'fas fa-users', color: 'purple' }
            ],
        };
    },
    methods: {
