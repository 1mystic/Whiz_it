const Admin = {
    ...
    methods: {
              ...
              plugins: {
                legend: {
                  ...
                  labels: {
                    boxWidth: 20,
                    padding: 15,
                    usePointStyle: true  // Optional: renders the legend items as points
                  }
                }
              },
              elements: {
      ...
      getQuizAttemptsData() {
        ...
        return {
          ...
          datasets: [{
            label: 'Attempts',
            data,
            backgroundColor: "rgba(88, 64, 50, 0.8)",
          }]
        };
      },
      getTopUsersData() {
      ...
      getDistributionData() {
        ...
        this.scores.forEach(s => {
          if (s.score >= 90) ranges['Excellent (90-100)']++;
          else if (s.score >= 70) ranges['Good (70-89)']++;
          else if (s.score >= 50) ranges['Average (50-69)']++;
          else ranges['Needs Improvement (<50)']++;
        });
        return {
